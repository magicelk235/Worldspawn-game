import socket,pygame,gui,random,events,default,entities,objects,items,threading,pickle,os,world_generation,uuid
...
class server:
    ...
    def recover(self):
        with open(f"{self.path}/server_data.pkl","rb") as file:
            ...
            with open(f"{self.path}/players/{server_data[1]}.pkl", "rb") as f:
